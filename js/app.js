document.addEventListener('DOMContentLoaded', async () => {
    ...
    const loadPanels = async () => {
        const res = await fetch(`${API_BASE_URL}/api/panels`, { credentials: 'include' });
        const data = await res.json();
        if (data.success) {
            panels = data.panels;
            renderPanels();
    ...
    const loadStats = async () => {
        const res = await fetch(`${API_BASE_URL}/api/stats/${currentPanelId}`, { credentials: 'include' });
        const data = await res.json();
        if (data.success) {
    ...
    const loadUsers = async () => {
        try {
            ...
            const res = await fetch(`${API_BASE_URL}/api/users/${currentPanelId}`, { credentials: 'include' });
    ...
    deleteUserBtn.onclick = async () => {
        ...
        const res = await fetch(`${API_BASE_URL}/api/users/${selectedUserId}`, { method: 'DELETE', credentials: 'include' });
        if (res.ok) {
            selectedUserId = null;
            showDetails('none');
            loadUsers();
    ...
    createUserBtn.onclick = async () => {
        ...
        const res = await fetch(`${API_BASE_URL}/api/users/${currentPanelId}`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
    ...
    const loadHWID = async () => {
        try {
            ...
            const res = await fetch(`${API_BASE_URL}/api/hwid/${currentPanelId}`, { credentials: 'include' });
            const data = await res.json();
            if (data.success) {
    ...
    saveHwidBtn.onclick = async () => {
        ...
        const res = await fetch(`${API_BASE_URL}/api/hwid/${selectedHwidId}`, {
            method: 'PATCH',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
                hwid: hwidVal.value,
    ...
    createHwidBtn.onclick = async () => {
        ...
        const res = await fetch(`${API_BASE_URL}/api/hwid/${currentPanelId}`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
    ...
    deleteHwidBtn.onclick = async () => {
        ...
        const res = await fetch(`${API_BASE_URL}/api/hwid/${selectedHwidId}`, { method: 'DELETE', credentials: 'include' });
        if (res.ok) {
            selectedHwidId = null;
            showHwidDetails('none');
            loadHWID();
    ...
    savePanelSettingsBtn.onclick = async () => {
        const res = await fetch(`${API_BASE_URL}/api/panels/${currentPanelId}`, {
            method: 'PATCH',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
    ...
    deleteActivePanelBtn.onclick = async () => {
        ...
        const res = await fetch(`${API_BASE_URL}/api/panels/${currentPanelId}`, { method: 'DELETE', credentials: 'include' });
        if (res.ok) {
            currentPanelId = null;
            loadPanels();
        }
